...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6LegLxAUAAAAALbrDVB57sYbAgVlAYzuJl1ouEBj',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6LegLxAUAAAAALpJ9ZpLosQoXFSn0szYvNT6fLwf',
